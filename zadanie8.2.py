...
def solve_ivp_with_adaptive_step(epsilon):
    ...
    while x < x_final:
        ...
        error, y_h, y_h2 = estimate_local_error(x, y, h, runge_kutta_2step, 2)
...
def main():
    ...
    print(f"Estimated solution: y1(pi) = {y_final[0]:.10f}, y2(pi) = {y_final[1]:.10f}")
